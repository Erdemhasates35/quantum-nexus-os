...
class CacheCommand(Command):
    ...
    def get_cache_dir(self, options: Values, args: list) -> None:
        if args:
            raise CommandError("Too many arguments")

        logger.info(options.cache_dir)

    def get_cache_info(self, options: Values, args: list) -> None:
        if args:
            raise CommandError("Too many arguments")
    ...
    def list_cache_items(self, options: Values, args: list) -> None:
        if len(args) > 1:
            raise CommandError("Too many arguments")
    ...
    def format_for_human(self, files: list) -> None:
        if not files:
    ...
    def format_for_abspath(self, files: list) -> None:
        if files:
            logger.info("\n".join(sorted(files)))

    def remove_cache_items(self, options: Values, args: list) -> None:
        if len(args) > 1:
            raise CommandError("Too many arguments")
    ...
    def purge_cache(self, options: Values, args: list) -> None:
        if args:
            raise CommandError("Too many arguments")
