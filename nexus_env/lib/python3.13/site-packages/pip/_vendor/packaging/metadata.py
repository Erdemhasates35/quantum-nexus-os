...
def _parse_project_urls(data: list) -> dict[str, str]:
...
class _Validator(Generic[T]):
    ...
    def _process_dynamic(self, value: list) -> list[str]:
    ...
    def _process_license_files(self, value: list) -> list[str]:
        paths = []
        for path in value:
            if ".." in path:
                raise self._invalid_metadata(
    ...
    def _process_import_names(self, value: list) -> list[str]:
